...
```{r}
ggplot(filtrados)+geom_line(aes(date, new_deaths_smoothed_per_million, color=location))+geom_line(data=espana, aes(date, new_deaths_smoothed_per_million), color="black", size=1.5)
```
